...
class AttributionReportingSourceRegistration:
    ...
    def from_json(cls, json):
        return cls(
            ...
            expiry=int(json['expiry']) if 'expiry' in json else None,
            event_report_window=int(json['eventReportWindow']) if 'eventReportWindow' in json else None,
            aggregatable_report_window=int(json['aggregatableReportWindow']) if 'aggregatableReportWindow' in json else None,
